      ...
      <div className="dashboard">
        <section className="main">
          <div className="code-container">
            ...
            <div className="code-container__code"></div>
          </div>
          <div className="preview-container">
            <h2 className="preview-container__title">Preview of the Site</h2>
            <div
              id="preview-container__html--id"
              className="preview-container__html"
            ></div>
          </div>
        </section>
        <button
        ...
        <section className="input">
          <div className="input__main">
            <form className="input-form">
              <div className="input__main-input">
                <h3 className="input__main-input-title title">
                  1. Enter a Value
                </h3>
                <div className="input__main-input-container">
                  ...
                  <label htmlFor="navbar">
                    Enter comma-separated items for Navbar, forms, and lists...
                  </label>
              ...
              <div className="input__main-buttons">
                ...
                <div className="input__main-buttons-list">
                  ...
                  <button
                    type="submit"
                    className="input__main-buttons-list-button"
                    onClick={(e) => {
                      e.preventDefault();
                      pluto.h1(
                  ...
                  <button
                    ...
                    onClick={(e) => {
                      ...
                      pluto.image(
                        e.target.form.imgurl.value,
                        e.target.form.imgwidth.value,
                        "image",
                        e.target.form.imgaria.value,
                        "preview-container__html--id"
                      );
                      updateCode();
                    }}
          ...
          <div className="input__crud">
            ...
            <div className="input__crud-buttons-list">
              <button
                className="input__crud-buttons-list-button"
                onClick={() => {
                  onDelete();
                }}
              >
